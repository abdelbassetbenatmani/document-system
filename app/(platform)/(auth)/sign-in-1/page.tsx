          ...
          <div className="grid grid-cols-4 gap-x-3">
            ...
            <button className="flex items-center justify-center py-2.5 border rounded-lg hover:bg-gray-50 duration-150 active:bg-gray-100">
              <svg
                ...
                <path
                  fill="#f1511b"
                  d="M22.994 22.994H0V0h22.994Z"
                  data-name="Path 6"></path>
                <path
                  fill="#80cc28"
                  d="M48.388 22.994h-23V0h22.994v22.994Z"
                  data-name="Path 7"></path>
                <path
                  fill="#00adef"
                  d="M22.994 48.392H0V25.398h22.994Z"
                  data-name="Path 8"></path>
                <path
                  fill="#fbbc09"
                  d="M48.388 48.392h-23V25.398h22.994v22.994Z"
                  data-name="Path 9"></path>
              </svg>
            </button>
            <button className="flex items-center justify-center py-2.5 border rounded-lg hover:bg-gray-50 duration-150 active:bg-gray-100">
              <svg
                ...
                <path
                  fill="#3b5999"
                  d="m21 0h-18c-1.655 0-3 1.345-3 3v18c0 1.654 1.345 3 3 3h18c1.654 0 3-1.346 3-3v-18c0-1.655-1.346-3-3-3z"></path>
                <path
                  fill="#fff"
                  d="m16.5 12v-3c0-.828.672-.75 1.5-.75h1.5v-3.75h-3c-2.486 0-4.5 2.014-4.5 4.5v3h-3v3.75h3v8.25h4.5v-8.25h2.25l1.5-3.75z"></path>
              </svg>
            </button>
            <button className="flex items-center justify-center py-2.5 border rounded-lg hover:bg-gray-50 duration-150 active:bg-gray-100">
              <svg
