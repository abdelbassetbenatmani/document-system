...
const Features = () => {
  ...
  return (
    <section className="relative">
      <div id="features" className="custom-screen-xl text-gray-300">
        <div className="duration-1000 delay-300">
          <div className="max-w-xl mx-auto text-center">
            <h2 className="toggleColor text-3xl font-semibold sm:text-4xl">
              Start growing your company with Documntary
            </h2>
            <p className="mt-3 toggleColor">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Ut iure
              suscipit reprehenderit molestias dignissimos unde.
            </p>
          </div>
        </div>
        <div className="duration-1000 delay-500">
                  ...
                  style={{
                    background:
                      theme === "dark"
                        ...
                        : "radial-gradient(157.73% 157.73% at 50% -29.9%, rgba(203, 213, 225, 0) 0%, rgba(203, 213, 225, 0.16) 100%)",
                  }}
                  >
                  <div className="w-12 h-12 flex items-center justify-center bg-gray-700 rounded-lg text-gray-50">
                    {item.icon}
                  </div>
                  <h3 className="text-lg toggleColor font-semibold">
                    {item.title}
                  </h3>
                  <p className="toggleColor">{item.desc}</p>
                </li>
              ))}
            </ul>
          </div>
